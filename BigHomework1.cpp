...
int ThanhTien(SP sp[], int n){
	...
	printf("_________________________________________________________________\n");
	for(int i=0; i<n; i++){
		TongtienSP=sp[i].Soluongsanpham*sp[i].Giasanpham;
		TongtienGH=TongtienGH+(sp[i].Soluongsanpham*sp[i].Giasanpham);
	}
	printf("\n-->Tong gia tien cua gio hang: %d VND\n", TongtienGH);
	printf("_________________________________________________________________\n");
}
...
int main(){
	...
	while(true){
        ...
        printf("***      7. Tong tien cua gio hang                         ***\n");
    	printf("***      8. Ghi toan bo noi dung vao file DSSP.txt         ***\n");
		...
		switch(key){
            ...
            case 7:
            	if(DaNhap){
            		printf("\nBan da chon Menu 7.Tong tien cua gio hang!\n");
					ThanhTien(sp,n);
                } else{
                	printf("\nBan can nhap thong tin trong menu 1 truoc !!!\n");
				}
            ...
            case 8:
            	if(DaNhap){
            		printf("\nBan da chon Menu 8.Ghi toan bo noi dung vao file!\n");
